...
public class KeywordsTest {
    public static void main(String... strings) throws IOException {
        File dir = new File("C:\\Users\\Maxim\\Dropbox\\(!)Shurka\\withKeysAndWithout\\strangeFiles");
        for (File file : dir.listFiles()) {
            System.out.println(metadataReader(file.getAbsolutePath()));
        }
        dir.listFiles();
    }
...
*/
/*        String result = tagList.get(7).getString(IptcDirectory.TAG_KEYWORDS,"UTF-8");
        return result;*//*
